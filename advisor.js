...
(async () => {
  ...
  // советник
  let advice = "✅ Всё в порядке. Продолжаем удерживать курс.";

  if (asp < 250) {
    advice = "📊 ASP слишком низкий. Рекомендуется: апсейлы, увеличение ассортимента, комплекты.";
  } else if (avgRevenue < 30000) {
    advice = "📉 Средняя выручка ниже нормы. Усильте промо и визуал в ключевые дни.";
  } else if (ebitda < 0) {
    advice = "🚨 EBITDA отрицательная. Необходимо сократить % расходов или повысить наценку.";
  }
